...
registerBlockType('mhm/post-excerpt', {
    title: _x('Post excerpt', 'Block title', 'pt-must-use'),
    description: _x(
        'This block automatically shows the current post excerpt. There are no options for this block. Edit the post excerpt as usual.',
        'Block instructions',
        'pt-must-use'
    ),
    icon: 'excerpt-view',
